...
namespace Auction.Data.Migrations
{
    ...
    [Migration("20260416204915_StoreLotImagesInDatabase")]
    partial class StoreLotImagesInDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auction.Data.Model.Account", b =>
                {
            ...
            modelBuilder.Entity("Auction.Data.Model.AuctionLot", b =>
                {
                    ...
                    b.Property<DateTime>("LastBitTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Auction.Data.Model.AuctionHistory", b =>
                {
                    b.HasOne("Auction.Data.Model.AuctionLot", "AuctionLot")
            ...
            modelBuilder.Entity("Auction.Data.Model.AuctionLot", b =>
                {
                    ...
                    b.HasOne("Auction.Data.Model.Account", "WinnerAccount")
                        .WithMany("WinningLots")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Auction.Data.Model.Account", null)
                        .WithMany()
