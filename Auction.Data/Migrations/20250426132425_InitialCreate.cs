        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentWinnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CurrentPrice = table.Column<double>(type: "float", nullable: false),
                    LastBitTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AuctionHistoryId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionLots_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuctionLots_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuctionHistories_AuctionLots_LotId",
                        column: x => x.LotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionHistories_LotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuctionLots_StartTime",
                table: "AuctionLots",
                column: "StartTime");

            migrationBuilder.CreateIndex(
                name: "IX_AuctionLots_WinnerId",
                table: "AuctionLots",
                column: "WinnerId");
        }
